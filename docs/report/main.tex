...
Tiến hành huấn luyện mô hình với bộ phân lớp \texttt{sklearn.linear\_model.LogisticRegression}, dùng các tham số mặc định. 
\begin{figure}[H]
	\begin{multicols}{2}
...
Tiến hành huấn luyện mô hình với bộ phân lớp \texttt{sklearn.ensemble.GradientBoostingClassifier}, dùng các tham số mặc định.
\begin{figure}[H]
	\begin{multicols}{2}
...
Khác với mô hình Na\"{\i}ve Bayes truyền thống, Multinomial Na\"{\i}ve Bayes
