...
Ứng dụng sử dụng microframework Flask để deploy trên nền web, giao diện sử dụng Bootstrap v5. Sản phẩm hoàn chỉnh có ở  \href{https://github.com/trhgquan/fakenews-detection}{GitHub Repository}.
